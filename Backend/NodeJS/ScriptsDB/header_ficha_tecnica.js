...
con.connect(function(err) {
	...
	sql = "INSERT INTO tecnicos (idTecnico, nome, username, password, email, tipo, habilitacoes, nivelProfissional) VALUES (8, 'Fernando dos Santos Antunes,', 'admin', 'admin', 'fsa@hotmail.com', 'admin', 'Mestrado', 7);";
	...
	sql = "INSERT into objetos(idObjeto, designacao, superCategoria, categoria, subCategoria, tipologia, localizacao, dimensoes, outrasDimensoes, conjunto, elementosConjunto, elementosAcessorios, marcasAutoria, marcasMontagem,marcasConstrucao, classificacaoPatrimonial, estilo, epoca, qualidade, estruturaMaterial, superficieMaterial, tecnicaEstrutura, tecnicaSuperficie, descricao, analogias, conclusoes, autoria, datacao, localOrigem, condicoesAmbientais) values (2, 'Piano de Brincar em Madeira', '', '', '','', '', '','', false,'','','','','', '','','','','','','','','','','','', '','',''),(3, 'Estante de missal', '', '', '','', '', '','', false,'','','','','', '','','','','','','','','','','','', '','',''),	(4, 'Gaiola', '', '', '','', '', '','', false,'','','','','', '','','','','','','','','','','','', '','',''),(5, 'Guarda Joias Império', '', '', '','', '', '','', false,'','','','','', '','','','','','','','','','','','', '','',''),(6, 'Oratório Policromado', '', '', '','', '', '','', false,'','','','','', '','','','','','','','','','','','', '','',''),(7, 'Sacrário de madeira policromada com resplendor entalhado na porta', '', '', '','', '', '','', false,'','','','','', '','','','','','','','','','','','', '','',''),	(8, 'Urna Santissimo', '', '', '','', '', '','', false,'','','','','', '','','','','','','','','','','','', '','','');";
	con.query(sql, function (err, result) {
		if (err) throw err;
		console.log("Values inserted");
	});
